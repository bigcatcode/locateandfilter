...
<div id="locate-anything-wrapper-post">
	...
	<div id="locate-anything-map-settings-page-1" class="locate-anything-map-option-pane locate-anything-map-settings-list-ul" style="width:auto" >
		...
		<?php _e("Latitude","locate-and-filter")?> <input type="text" name="locate-anything-lat" value="<?php echo $post_params['locate-anything-lat']; ?>">
     ...
     <table id="locate-anything-map-settings-page-4" class="locate-anything-map-option-pane locate-anything-map-settings-list-ul" style='width:auto;display:none'>
        ...
        <tr id="nice-tooltips-settings">
			<td><?php _e("Nice Tooltips settings","locate-and-filter")?> : &nbsp;<input type="button" data-target="nice-tooltips-settings" class="locate-anything-help"></td>
			<td><?php _e("Main image max-height","locate-and-filter")?> : <input type="text" value="<?php echo $post_params["locate-anything-nice-tooltips-img-height"]; ?>" name="locate-anything-nice-tooltips-img-height"></td>
		</tr>
        <tr>
    ...
    <table id="locate-anything-map-settings-page-2" class="locate-anything-map-option-pane locate-anything-map-settings-list-ul" style='display:none'>
        <tr>
       		<td><h2><?php _e("Choose a marker icon","locate-and-filter")?></h2></td>
       	</tr>  
        <tr>
            <td width="40%">               	
		...
		<tr>
			<td id="medialibrary" class="only_pro">
				...
				<b><?php _e("Add an icon from the media library","locate-and-filter");?></b>&nbsp;
			...
			<td>
				...
				<div class="uploader">
					...
					<input id="locate-anything-marker-type_button" class="button-admin"  name="locate-anything-marker-type_button" type="text" value="<?php _e("Add","locate-and-filter"); ?>" />
				</div>
		...
		<tr>
			<td>
				...
				<b><?php _e("Create an icon","locate-and-filter"); ?> </b> 
			</td>
			<td style="padding: 15px;line-height: 35px;">	
				<!-- Awesome marker creator -->
				<?php _e("Symbol","locate-and-filter"); ?> : 
				...
				<br>
				<?php _e("Symbol color","locate-and-filter")?> : 
	...
	<table id="locate-anything-map-settings-page-3" class="locate-anything-map-option-pane locate-anything-map-settings-list-ul"  style='display:none' >
		<tr>
			<td><h2><?php _e("Additional fields","locate-and-filter")?></h2></td>
		</tr>  
		<tr>
			<td>
