...
<div id="locate-anything-wrapper-post">
	...
	<h2 class="nav-tab-wrapper">
	    <a  data-pane="1" class="active nav-tab"><?php _e("Geo settings","locateandfilter")?></a>
	    <a  class="nav-tab" data-pane="2"><?php _e("Marker","locateandfilter")?></a>
	    <a  class="nav-tab" data-pane="4"><?php _e("Tooltip","locateandfilter")?></a>
	    <a  class="nav-tab" data-pane="3"><?php _e("Additional Fields","locateandfilter")?></a>
	</h2>
	...
	<div id="locate-anything-map-settings-page-1" class="locate-anything-map-option-pane locate-anything-map-settings-list-ul" style="width:auto" >
		...
		<?php _e("Latitude","locateandfilter")?> <input type="text" name="locate-anything-lat" value="<?php echo $post_params['locate-anything-lat']; ?>">
		<?php _e("Longitude","locateandfilter")?> <input type="text" name="locate-anything-lon" value="<?php echo $post_params['locate-anything-lon']; ?>">
     ...
     <table id="locate-anything-map-settings-page-4" class="locate-anything-map-option-pane locate-anything-map-settings-list-ul" style='width:auto;display:none'>
        <tr><td><h2><?php _e("Customize Tooltip template","locateandfilter")?></h2></td></tr>  
        <tr>
        ...
        <tr id="nice-tooltips-settings">
			<td><?php _e("Nice Tooltips settings","locateandfilter")?> : &nbsp;<input type="button" data-target="nice-tooltips-settings" class="locate-anything-help"></td>
			<td><?php _e("Main image max-height","locateandfilter")?> : <input type="text" value="<?php echo $post_params["locate-anything-nice-tooltips-img-height"]; ?>" name="locate-anything-nice-tooltips-img-height"></td>
		</tr>
        <tr>
           <td id="customtemplate" width="40%">
	           	<div id="locate-anything-marker-html-template">
					<b><?php _e("Custom HTML template","locateandfilter");?></b>&nbsp;<input type="button" data-target="customtemplate" class="locate-anything-help">
			...
			<td id="addifields">
				<div class="LA_additional_fields_notice">
					<b><?php _e("Available fields","locateandfilter")?></b>&nbsp;<input type="button" data-target="addifields" class="locate-anything-help">
					<p><?php _e("Here is a list of the additional fields available for display in the template. To use them just copy/paste the corresponding tag in the template editor","locateandfilter"); ?></p>
    ...
    <table id="locate-anything-map-settings-page-2" class="locate-anything-map-option-pane locate-anything-map-settings-list-ul" style='display:none'>
        <tr>
       		<td><h2><?php _e("Choose a marker icon","locateandfilter")?></h2></td>
       	</tr>  
        <tr>
            <td width="40%">               	
               	<input type="radio" name="locate-anything-marker-type" value="standard" <?php if ($post_params["locate-anything-marker-type"]=="standard" || $post_params["locate-anything-marker-type"]==false ) echo 'checked' ?>> <b><?php _e("Choose an icon","locateandfilter")?></b> :  
			</td>
			<td>
				<select style="width: 50% !important" name="locate-anything-custom-marker" id="locate-anything-custom-marker">
					<option value=""><?php _e("Use default marker","locateandfilter"); ?></option>
		...
		<tr>
			<td id="medialibrary" class="only_pro">
				...
				<b><?php _e("Add an icon from the media library","locateandfilter");?></b>&nbsp;
			...
			<td>
				...
				<div class="uploader">
					...
					<input id="locate-anything-marker-type_button" class="button-admin"  name="locate-anything-marker-type_button" type="text" value="<?php _e("Add","locateandfilter"); ?>" />
				</div>
		...
		<tr>
			<td>
				...
				<b><?php _e("Create an icon","locateandfilter"); ?> </b> 
			</td>
			<td style="padding: 15px;line-height: 35px;">	
				<!-- Awesome marker creator -->
				<?php _e("Symbol","locateandfilter"); ?> : 
				...
				<br>
				<?php _e("Symbol color","locateandfilter")?> : 
	...
	<table id="locate-anything-map-settings-page-3" class="locate-anything-map-option-pane locate-anything-map-settings-list-ul"  style='display:none' >
		<tr>
			<td><h2><?php _e("Additional fields","locateandfilter")?></h2></td>
		</tr>  
		<tr>
			<td>
...
<script type="text/javascript">
	...
	function locate_anything_select_preset(e){
	  if (confirm("<?php _e('Do you want to overwrite the current tooltip template?','locateandfilter'); ?>")) jQuery("#marker-html-template").val( jQuery('#locate-anything-tooltip-preset :selected').attr("data-template") );
	}
</script>   
